...
//import com.otomogroove.OGReactNativeWaveform.AmplitudeManager;
...
//            if(soundFile!=null) {
//                Log.e("AMPLITUDE","yeah ! soundfile is NOT NULL");
//
...
//
//    private AmplitudeManager mAmplitudeManager;
//
//    public WaveformView(Context context, OGWaveView waveView, AmplitudeManager manager) {
//        super(context);
//
//        this.waveView = waveView;
//        this.mAmplitudeManager = manager;
//
...
//
//        AmplitudeManager.SoundListener soundListener;
//
//
//
//        mSoundFile = null;
...
//        if(soundFile != null) Log.e("AMPLITUDE", "SOUNDFILE NOT NULL");
//        else Log.d("AMPLITUDE", "SOUNDFILE IS NULL...");
//        mSoundFile = soundFile;
//        mSampleRate = mSoundFile.getSampleRate();
//        mSamplesPerFrame = mSoundFile.getSamplesPerFrame();
//
////        double[] doubles = computeDoubles();
//////
////        for(double val : doubles){
////            Log.d("DOUBLES", String.valueOf(val));
////        }
////        Log.d("DOUBLES, nb valeurs", String.valueOf(doubles.length));
//
////        mListener = waveView.getWaveformListener();
////        mListener.waveformHasSound();
//
//        mAmplitudeManager.hasSound();
//
//
...
//        if(hasSoundFile()) Log.d("AMPLITUDE", "global soundfile NOT NULL");
//        else Log.d("AMPLITUDE", "global soundfile is NULL...");
//
//        Log.e("AMPLITUDE","computeDoublesForAllZoomLevels");
...
//
//
//    public WritableArray computeDoubles() {
////        while(!hasSoundFile()){
////            Log.d("AMPLITUDE", "Waiting…");
////        }
//        if(hasSoundFile()) Log.e("AMPLITUDE", "global soundfile NOT NULL");
//        else Log.e("AMPLITUDE", "global soundfile is NULL...");
//
//        WritableArray result = new WritableNativeArray();
//        Log.e("AMPLITUDE","computeDoubles");
//        int numFrames = mSoundFile.getNumFrames();
//        int[] frameGains = mSoundFile.getFrameGains();
////        double[] smoothedGains = new double[numFrames];
////        if (numFrames == 1) {
